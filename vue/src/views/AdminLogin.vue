    ...
    <div class="login-shell">
      ...
      <div class="login-hero">
        <div class="hero-main">
          ...
          <h2 class="hero-title">后台管理中心</h2>
          <p class="hero-subtitle">系统管理员登录入口</p>

          <ul class="hero-feature-list">
            <li class="feature-item">
              <span class="feature-dot"></span>
              <span>课程、学生、教师统一管理</span>
            </li>
            <li class="feature-item">
              <span class="feature-dot"></span>
              <span>支持角色与权限灵活配置</span>
            </li>
            <li class="feature-item">
              <span class="feature-dot"></span>
              <span>系统运行情况一目了然</span>
            </li>
          </ul>
        </div>
      </div>
...
function setParallaxVars(px, py) {
  ...
  const rx = py * -0.35 // 上下移动控制 X 轴轻微倾斜
  const ry = px * 0.4   // 左右移动控制 Y 轴轻微倾斜
...
.bg-grid {
  ...
  mask-image: radial-gradient(circle at 50% 50%, rgba(0,0,0,0.75), rgba(0,0,0,0));
}
...
.orb-2 {
  ...
  height: 520px;
  opacity: 0.45;
  background: radial-gradient(circle at 35% 35%, rgba(16, 185, 129, 0.75), rgba(6, 182, 212, 0.18), rgba(16, 185, 129, 0));
...
.login-shell {
  ...
  transform: translate3d(0, 8px, 0) scale(0.99) rotateX(var(--rx, 0deg)) rotateY(var(--ry, 0deg));
  opacity: 0;
...
.login-panel {
  ...
  background:
    ...
    linear-gradient(145deg, rgba(255, 255, 255, 0.9), rgba(236, 252, 203, 0.9));
  box-shadow:
...
.login-form {
  ...
  border-radius: 18px;
  background: radial-gradient(circle at 0 0, rgba(240, 249, 255, 0.9), rgba(240, 253, 250, 0.96));
  box-shadow:
...
.form-input :deep(.el-input__wrapper:hover) {
  ...
  box-shadow:
    ...
    0 14px 28px rgba(5, 150, 105, 0.3);
...
@keyframes orbFloat1 {
  ...
  50% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(26px, 18px) scale(1.05); }
  100% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(6px, -6px) scale(1.02); }
}

@keyframes orbFloat2 {
  0% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(0, 0) scale(1.02); }
  50% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(-22px, 22px) scale(1.06); }
  100% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(-10px, -6px) scale(1.03); }
}

@keyframes orbFloat3 {
  0% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(0, 0) scale(1.01); }
  50% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(18px, -20px) scale(1.05); }
  100% { transform: translate3d(var(--px, 0px), var(--py, 0px), 0) translate(-8px, -6px) scale(1.03); }
}
